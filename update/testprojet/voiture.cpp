...
voiture::voiture(QString id_voiture, QString nom_voiture, QString prix, QString nbr_location, QString nbr_reparation, QString disponibilite,QString chauffeur)
...
voiture::voiture(QString nom_voiture, QString prix, QString nbr_location, QString nbr_reparation, QString disponibilite,QString chauffeur)
{
    this->nom_voiture=nom_voiture;
    this->prix=prix;
    this->nbr_location=nbr_location;
...
bool voiture::ajouter_voiture()
{
    ...
    query.prepare("INSERT INTO voiture (nom_voiture, prix, nbr_location, nbr_reparation, disponibilite, chauffeur) "
                        "VALUES (:nom_voiture, :prix, :nbr_location, :nbr_reparation, :disponibilite, :chauffeur)");
...
model->setHeaderData(4,Qt::Horizontal,QObject::tr("nbr_reparation"));
model->setHeaderData(5,Qt::Horizontal,QObject::tr("disponibilite"));
model->setHeaderData(6,Qt::Horizontal, QObject::tr("chauffeur"));
